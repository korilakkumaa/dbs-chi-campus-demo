import type { SchoolCalendarRow } from './schoolCalendar2627'

/** DBS 2025/26 school calendar seed rows. Period: 2025-09-01 – 2026-08-31. */
const ROWS: SchoolCalendarRow[] = [
...
export function buildSchoolCalendar2526Rows(): SchoolCalendarRow[] {
  return ROWS
}
